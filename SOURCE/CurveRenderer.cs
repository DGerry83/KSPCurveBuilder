...
namespace KSPCurveBuilder
{
    ...
    public class CurveRenderer : IDisposable
    {
        ...
        private List<FloatString4> _points = new();
        ...
        // CRITICAL: Maximum safe coordinate range for GDI+ to prevent overflow
        private const float MAX_COORDINATE = 1e6f;
        private const float MIN_COORDINATE = -1e6f;

        /// <summary>Creates a new CurveRenderer with persistent GDI+ resources.</summary>
        ...
        {
            // CRITICAL: Validate inputs to prevent NaN/Infinity propagation
            _points = points ?? new List<FloatString4>();
            _curve = curve;
        ...
        public void Render(Graphics g)
        {
            ...
            // CRITICAL: Validate bounds before any GDI+ calls to prevent overflow
        ...
        private void DrawCurve(Graphics g)
        {
            ...
            {
                g.DrawCurve(_curvePen, curvePoints.ToArray());
            }
        }
        ...
        private void DrawPoints(Graphics g)
        {
            ...
            for (int i = 0; i < _points.Count; i++)
            {
                ...
                // CRITICAL: Validate coordinates before GDI+ call to prevent overflow
        ...
        /// <summary>Validates that a coordinate is safe for GDI+ drawing.</summary>
