...
namespace KSPCurveBuilder
{
    ...
    public class DataGridController
    {
        ...
        private void OnMouseMove(object? sender, MouseEventArgs e)
        {
            ...
            // CRITICAL: Direct list update - bypass all services and binding
            ...
            // CRITICAL: Direct PictureBox refresh - NO DataGridView updates
            _pictureBox.Refresh();
        ...
        private void OnMouseUp(object? sender, MouseEventArgs e)
        {
            if (_isDragging)
            {
                ...
                // CRITICAL: Now commit to BindingList and fire events
                var points = _editorService.PointsInternal;
                if (_dragRowIndex >= 0 && _dragRowIndex < points.Count)
                {
                    // This will update the DataGridView cell
        ...
        private float GetDragSpeedMultiplier() => DragSpeedCalculator.GetSpeedMultiplier();
    }
}