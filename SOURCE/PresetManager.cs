...
public static class PresetManager
{
    ...
    /// <summary>Ensures the preset folder exists.</summary>
    ...
    /// <summary>Saves a preset to file.</summary>
    ...
    /// <summary>Loads a preset from file.</summary>
    ...
    /// <summary>Gets all available preset names.</summary>
    ...
    /// <summary>Parses a preset from key string lines.</summary>
