...
namespace KSPCurveBuilder
{
    ...
    /// </summary>
    public class CurveEditorService
    {
        ...
        public CurveEditorService(List<FloatString4> points, BindingList<FloatString4> bindingList)
        {
            ...
            _bindingList = bindingList ?? throw new ArgumentNullException(nameof(bindingList));
        }
        ...
        // CRITICAL: For drag operations - doesn't fire PointsChanged
        ...
        public void SortByTimeSilently()
        {
            _points.Sort();
            _bindingList.ResetBindings();
            // Only fire silent event - doesn't trigger textbox/undo
            SilentPointsChanged?.Invoke(this, EventArgs.Empty);
        }
